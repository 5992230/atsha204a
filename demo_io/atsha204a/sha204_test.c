...
{
	0x00,0x25,0x16,0x20,0x82,0x67,0xad,0x8c,
	0xe9,0x14,0xa1,0x87,0xf5,0x94,0x49,0xcd,
	0x23,0x75,0x64,0xd5,0xFF,0x3c,0x3a,0x40,
...
static uint8_t wakeup_response_buffer[10] = {0};
...
uint8_t TestReadConfig(void)
{
	...
	if(I2C_SUCCESS != state)
	{
		printf("wakeup fail! state:0x%02x\n",state);
		return state;
	}
